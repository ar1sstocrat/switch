...
$lang['login_unsuccessful_not_active']           = 'Вход невозможен, так как ваша учетная запись не активирована. Пожалуйста обратитесь к администратору.';
...
$lang['email_forgot_password_error']         = 'Пароль небыл отправлен. Пожалуйста повторите процедуру сброса. Если сообщение появиться вновь, обратитесь к Администротору. Вы будуте перенаправлены на страницу восстановления автоматически';