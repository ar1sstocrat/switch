 ...
 */
$config['site_title']                 = "TECH";       // Site Title, example.com
$config['admin_name']                 = "ADMIN TECH"; //Admin Name, ADMIN SITE 
$config['admin_email']                = "voliawebmastervin@yandex.ru"; // Admin Email, admin@example.com
...
$config['email_config'] = array(
	'mailtype' => 'html',
        ...
        'smtp_port' => '465',
        'smtp_user' => 'voliawebmastervin@yandex.ru',
        'smtp_pass' => 'voliawebmastervin1234',
        'smtp_crypto' => 'ssl'
);
